...
const ScrollablePopupMenu = new Lang.Class({
    ...
    _init: function(sourceActor, arrowAlignment, arrowSide) {
        ...
        this.trainSection = new St.BoxLayout({
            vertical: true,
            style_class: 'trainSection'
        });

        this.trainSection.set_style('padding-bottom: 12px');

        this.boxlayout.add(this.trainSection);

        this.trainSection.add((new PopupMenu.PopupSeparatorMenuItem()).actor);
